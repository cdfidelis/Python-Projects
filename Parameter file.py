...
bot = InstaBot(
    login="eafsasgasgs",  # Enter username (lowercase). Do not enter email!
    password="safsgw4rwasf",
    like_per_day=24000,
    comments_per_day=7200,
    tag_list=["gaintrain", "got", "gainpost", "gaintrain", "gaintrain"],
    ...
    # Enable the following to schedule the bot. Uses 24H
     end_at_h = 19, # Hour you want the bot to stop
     end_at_m = 30, # Minute you want the bot stop, in this example 23:30
     start_at_h = 1, # Hour you want the bot to start
